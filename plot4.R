...
par(mfrow = c(2, 2))
plot(test.sub$Time, test.sub$Global_active_power, type="l", xlab="", ylab="Global Active Power")
plot(test.sub$Time, test.sub$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(test.sub$Time, test.sub$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
